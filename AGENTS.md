...
This file is the repository-level entry point for AI agents working on BeekeepingSim.
...
BeekeepingSim is an Unreal Engine project. The primary source scope is:
