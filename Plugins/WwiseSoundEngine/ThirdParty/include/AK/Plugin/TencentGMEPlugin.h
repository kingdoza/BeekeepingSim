 ...
 * @struct DEV_INFO
 * @var strDevNameUTF8 Device name, UTF8 encoded, maximum length 512 bytes
 * @var strDevIdUTF8 Device ID, UTF8 encoded, maximum length 512 bytes
 */
typedef struct
{
	char strDevNameUTF8[512];
	char strDevIdUTF8[512];
} DEV_INFO;
...
/*
    The following APIs are for device selection
*/
...
/**
 * @deprecated This API is deprecated, please use GMEWWisePlugin_SelectMicDeviceByDevId instead.
 * @brief Selects a microphone device to be used by device ID.
 * @deprecated Use GMEWWisePlugin_SelectMicDeviceByDevId instead.
...
/**
 * @brief Selects a microphone device to be used by device ID string.
 * 
 * @param devIdUTF8 The device ID string (UTF-8 encoded) of the microphone device to select.
 * @return Operation result code:
 *	0: Successfully selected the microphone device
 *	Non-zero: Failed to select the microphone device, refer to SDK documentation for error codes
 */
extern "C"
int GMEPlugin_API_CALL GMEWWisePlugin_SelectMicDeviceByDevId(const char* devIdUTF8);
